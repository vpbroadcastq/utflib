...
std::span<testdata_invalid_utf8_utf32> get_invalid_utf8_utf32_sequences() {
	static std::array<testdata_invalid_utf8_utf32,15> d {{
		{
			// 0
		...
		{
			// 6
			// Trailing invalid subsequence(s)
			// TODO:  Corresponding test data for utf-16
			{0x00, 0xF0,   0x21, 0x9F,   0x99,   0xC2  },
			{0x00, 0xFFFD, 0x21, 0xFFFD,               },
			{0x00, 0xFFFD, 0x21, 0xFFFD, 0xFFFD, 0xFFFD}
		},
		{
			// 7
